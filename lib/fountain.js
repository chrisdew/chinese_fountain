...
function Fountain16(data, bundle_size) {
  ...
  //console.log('this.bundle_size', this.bundle_size);
  this.bundle_shorts = 0 | (this.bundle_size / SIZE_OF_SHORT);
  //console.log('this.bundle_shorts', this.bundle_shorts);
  ...
  //console.log('this.padded_length', this.padded_length);
  ...
  //console.log('this.min_bundles', this.min_bundles);
  ...
  //console.log('this.hunk_size', this.hunk_size);
  ...
  for (var i = 0; i < this.num_hunks; i++) {
    //console.log('this.padded_data', this.padded_data, i * this.hunk_size, (i+1) * this.hunk_size);
  ...
  //console.log('this.mpz_hunks', this.mpz_hunks);
}
